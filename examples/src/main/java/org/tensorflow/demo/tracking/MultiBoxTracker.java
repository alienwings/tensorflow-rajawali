...
public class MultiBoxTracker {
    ...
    private DrawLocactionCallback drawLocactionCallback;
    ...
    public void setDrawLocactionCallback(DrawLocactionCallback drawLocactionCallback) {
        this.drawLocactionCallback = drawLocactionCallback;
    }
    ...
    public synchronized void draw(final Canvas canvas) {
        ...
        for (final TrackedRecognition recognition : trackedObjects) {
            ...
            if (drawLocactionCallback != null) {
                drawLocactionCallback.onLocationDraw(trackedPos, labelString);
            }
        }
    }
    ...
    public interface DrawLocactionCallback {
        void onLocationDraw(RectF rect, String title);
    }
}
